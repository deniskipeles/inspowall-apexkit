    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="bg-surface border border-black/10 dark:border-white/10 p-8 rounded-3xl w-full max-w-md shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          {error && <div className="bg-red-500/10 border border-red-500/20 text-red-500 px-4 py-3 rounded-xl text-sm">{error}</div>}
          <div>
          ...
          <button type="submit" className="w-full bg-neon text-ink font-bold py-3 rounded-xl mt-4 hover:bg-white transition-colors shadow-[0_0_20px_rgba(204,255,0,0.2)]">
            Log In
          </button>
        </form>
